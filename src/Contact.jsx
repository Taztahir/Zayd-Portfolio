...
function Contact(){
    return(
        <section id="contact" className="grid lg:grid-cols-2 items-center max-md:py-10">
            {/* image  */}
            ...
            <div className="md:px-16 space-y-5 px-5">
                ...
                <form action="https://formsubmit.co/taztaz162004@gmail.com" className="grid space-y-5 comic-neue-regular text-2xl" method="POST">
                    ...
                    <textarea name="Messge" id="" placeholder="Say Somthing" className="border-2 py-3 px-4 outline-[#ff9000] rounded-sm w-full border-[#dfdfdf] lg:w-130 pb-40"></textarea>
