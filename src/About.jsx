...
const AboutSection = () => {
  return (
    <section id="about" className="bg-[#0f0715] text-white py-10 px-6 sora">
      <div className="">
        <StatsSection />
      </div>
      {/* About Section */}
      <div className="max-w-6xl mx-auto md:flex gap-10 space-y-10">
        ...
        {/* Right Card */}
        <div className="bg-[#12091c] border border-[#2A1454] rounded-2xl flex lg:w-[1500px] flex-col justify-between">
          <div className="p-10">
